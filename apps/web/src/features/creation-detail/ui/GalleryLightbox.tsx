...
/**
 * Full-screen zoom, built on the same Radix Dialog pattern as
 * `components/navigation/MobileDrawer.tsx` — free focus-trap + Escape-to-close.
 * Real Stitch screen only shows the "Zoom" trigger button (`zoom_in` icon,
 * bottom-right of the main image) on the static desktop capture; this modal's
 * own layout isn't a distinct Stitch screen (see docs/pages/creation-detail.md).
 */
      ...
      <Dialog.Portal>
        ...
        >
          ...
          <div className="relative h-full w-full max-w-5xl">
            <Image
              src={activeMedia.url}
              alt={activeMedia.altText || altFallback}
              fill
              sizes="100vw"
