 ...
 * distinct photo (never duplicates the large photo right beside itself).
 */
export function AtelierHeroGallery({ atelier }: { atelier: AtelierDto }) {
  ...
  return (
    <section className="px-8 pb-16">
      <div className="mb-12 text-center">
        ...
        <p className="text-sm tracking-widest text-angaly-slate uppercase">Le cœur de la création sur mesure</p>
      </div>
      <div className="grid h-[60vh] min-h-[500px] grid-cols-1 gap-4 md:grid-cols-12">
        ...
        <div className="flex h-full flex-col gap-4 md:col-span-4">
          ...
          <div className="flex h-1/2 flex-col items-center justify-center bg-angaly-warm-ivory p-8 text-center">
            ...
            <p className="font-heading text-2xl text-angaly-navy italic">L&apos;art de la précision</p>
          </div>
        </div>
      </div>
    </section>
