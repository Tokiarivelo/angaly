...
/** Same pattern as `orders`/`payments`/`quotes`' own copy (see their `application/lib/resolve-customer-id.ts`) — duplicated per module rather than imported cross-module. */
