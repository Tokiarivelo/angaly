...
- **Endpoint public de lecture ajouté dans une session suivante** (2026-09-16, suite) : la
  ...
  `la-une`/`nos-creations-galerie`/`creation-detail`/`contact` (6 des 14 pages Phase 1) le
  consomment. Les 8 autres pages de la Phase 1 restent sur leurs littéraux codés en dur ;
...
- **Pages consommatrices** : `admin-gestion-contenu` (édition, endpoints `content/sections`).
  `home`, `a-propos`, `la-une`, `nos-creations-galerie`, `creation-detail` et `contact`
  (lecture publique, endpoint `content/public/:page`) — 6 pages sur les 14 de la Phase 1, voir
  ...
  et l'écart ci-dessus. Les 8 autres pages publiques restent à migrer.
...
- [x] `home`/`a-propos`/`la-une`/`nos-creations-galerie`/`creation-detail`/`contact` lisent
      ...
      avec repli testé sur les littéraux codés en dur pour toute section absente/`DRAFT`
